namespace Database5
{
    public partial class Form1 : Form
    {
        ...
        {
            string userInput = ShowInputDialog("", "Введіть назву бази даних:");
            manager.CreateDB(userInput);
        ...
        private (string comboBoxValue, string textBoxValue) ShowColumnDialog(string caption, string text)
        {
            ...
            comboBox.Items.AddRange(new string[] { "String", "Integer", "Char", "Real", "HTML", "StrinhInvl" });
